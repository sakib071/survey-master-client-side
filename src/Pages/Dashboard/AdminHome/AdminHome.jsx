...
const AdminHome = () => {
    ...
    const pieChartData = chartData.map(data => {
        return { name: data.category, value: data.votes }
    })
    ...
    return (
        <div>
            <h2 className="text-2xl mb-10">
                ...
                {
                    user?.displayName ? <span className='text-yellow-400 font-semibold'>{user.displayName}</span> : 'Back'
                }
            </h2>
            ...
            <div className="stats shadow">
                ...
                <div className="stat">
                    <div className="stat-figure text-yellow-400">
                        <RiSurveyFill className='text-3xl' />
                    </div>
                    <div className="stat-title">Surveys</div>
                    <div className="stat-value">{stats.survey}</div>
                    <div className="stat-desc">↗︎ 400 (22%)</div>
                </div>
